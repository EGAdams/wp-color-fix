...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2020 at 05:40 PM
...
CREATE TABLE `test_table` (
  ...
  `test_message` varchar(1024) COLLATE utf8_unicode_ci NOT NULL,
  `test_status` varchar(128) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `wp_areacitystatecountrylatlong`
--

CREATE TABLE `wp_areacitystatecountrylatlong` (
...
--
-- Table structure for table `wp_arealocationphonelog`
--

CREATE TABLE `wp_arealocationphonelog` (
  `localPhoneNumber` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `wp_floating_phone_settings`
--

CREATE TABLE `wp_floating_phone_settings` (
  `floating_phone_response_settings_json` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `wp_hours_of_operation`
--

CREATE TABLE `wp_hours_of_operation` (
  `customer_id` int(11) NOT NULL,
  `hours_of_operation_json` varchar(1024) CHARACTER SET utf8 NOT NULL,
  `phone_icon_color` varchar(7) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `wp_mcba`
--

CREATE TABLE `wp_mcba` (
  `id` int(11) NOT NULL,
  `mcba_id` int(11) DEFAULT NULL,
  `template_dir` text
...
--
-- Table structure for table `wp_mcba_users`
--

CREATE TABLE `wp_mcba_users` (
  `ID` int(11) NOT NULL,
...
--
-- Table structure for table `wp_mcba_chat_configuration`
--

CREATE TABLE IF NOT EXISTS `wp_mcba_chat_configuration` (
  `id` int(11) NOT NULL,
  `configuration_name` varchar(1000) NOT NULL,
  `configuration_value` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
--
-- Dumping data for table `wp_mcba_chat_configuration`
--

INSERT INTO `wp_mcba_chat_configuration` (`id`, `configuration_name`, `configuration_value`) VALUES
(1, 'chat_main_color', '#e67d05'),
(2, 'chat_system_enabled', '1'),
(3, 'phone_number', '7274855221');
...
--
-- Indexes for table `wp_mcba_chat_configuration`
--
ALTER TABLE `wp_mcba_chat_configuration`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `wp_mcba_chat_configuration`
--
ALTER TABLE `wp_mcba_chat_configuration`
...
--
-- Table structure for table `wp_phone_numbers`
--

CREATE TABLE `wp_phone_numbers` (
  `customer_id` int(10) NOT NULL,
  `phone_number` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `default_number` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `wp_settings` (
  `json_settings` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `wp_user_login_log`
--

CREATE TABLE `wp_user_login_log` (
  `id` int(11) NOT NULL,
  `uid` int(11) NOT NULL,
...
--
-- Indexes for table `wp_mcba_users`
--
ALTER TABLE `wp_mcba_users`
  ADD PRIMARY KEY (`ID`);
...
--
-- Indexes for table `wp_user_login_log`
--
ALTER TABLE `wp_user_login_log`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `wp_mcba`
--
ALTER TABLE `wp_mcba`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `wp_mcba_users`
--
ALTER TABLE `wp_mcba_users`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `wp_user_login_log`
--
ALTER TABLE `wp_user_login_log`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
