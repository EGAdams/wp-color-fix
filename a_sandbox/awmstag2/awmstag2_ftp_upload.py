...
remote_base = "/floridascarwash.com/wp-content/plugins/MCBA-Wordpress/"
ftp_upload('floridascarwash.com', 'awmstag2', 'z8nqm61V.E[XN2', local_base + "MCBA-Wordpress/js/mcba_functions.js", remote_base + "js" )
