...
(function (jQuery) {
	jQuery.fn.higooglefonts = function (options) {
		...
		this.select2({
			...
			templateResult: function (result) {
				//var state = jQuery('<div style="background-position:-10px -'+y+'px !important;" class="li_'+result.itemId+'">'+result.text+'</div>');
